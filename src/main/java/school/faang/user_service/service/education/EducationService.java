...
public class EducationService {
    ...
    public EducationDto addEducation(UserDto userDto, EducationDto educationDto) {
    ...
    public EducationDto updateEducation(UserDto userDto, EducationDto educationDto) {
        validate(educationDto);
