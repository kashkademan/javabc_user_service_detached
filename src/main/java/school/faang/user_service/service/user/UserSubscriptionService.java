...
public interface UserSubscriptionService {
    ...
    /**
     * The followUser method is designed to create a subscription to a user. It takes into account the business requirement that the user
    ...
    /**
     * The unfollowUser method is designed to subscribe to a user. It takes into account the business requirement that the user
     ...
     * @since 1.0
     * @return returns a Count Response object containing information about the number of subscribers the user has
     */
     ...
     * @since 1.0
     * @return returns a Count Response object containing information about the number of subscriptions the user has
     */
