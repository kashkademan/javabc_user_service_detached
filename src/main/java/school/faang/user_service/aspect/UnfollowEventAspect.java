...
import school.faang.user_service.annotation.PublishUnfollowEventKafka;
...
@Slf4j
public class UnfollowEventAspect {
    ...
    public void publishSubscriptionEvent(JoinPoint joinPoint, PublishUnfollowEventKafka publishEvent) {
        ...
        unfollowEventPublisher.publish(
